...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AbnormalChecker.CategoriesData, AbnormalChecker", CategoriesData.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == CategoriesData.class)
			mono.android.TypeManager.Activate ("AbnormalChecker.CategoriesData, AbnormalChecker", "", this, new java.lang.Object[] {  });
	}

	public CategoriesData (android.content.Context p0)
	{
		super ();
		if (getClass () == CategoriesData.class)
			mono.android.TypeManager.Activate ("AbnormalChecker.CategoriesData, AbnormalChecker", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}

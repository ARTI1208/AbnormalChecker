...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AbnormalChecker.OnBoardingLib.Code.FadeView, AbnormalChecker", FadeView.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == FadeView.class)
			mono.android.TypeManager.Activate ("AbnormalChecker.OnBoardingLib.Code.FadeView, AbnormalChecker", "", this, new java.lang.Object[] {  });
	}

	public FadeView (android.view.View p0, boolean p1)
	{
		super ();
		if (getClass () == FadeView.class)
			mono.android.TypeManager.Activate ("AbnormalChecker.OnBoardingLib.Code.FadeView, AbnormalChecker", "Android.Views.View, Mono.Android:System.Boolean, mscorlib", this, new java.lang.Object[] { p0, p1 });
	}

...
containing a value of this type.
        ...
        */
        ...
        /** Attributes that can be used with a BackgroundStyle.
           ...
           <tr><td><code>{@link #BackgroundStyle_selectableItemBackground android.support.compat:selectableItemBackground}</code></td><td> Need a non-android: attr here so that gradle doesn't remove it </td></tr>
           </table>
...
containing a value of this type.
        ...
        */
        ...
        /** Attributes that can be used with a CheckBoxPreference.
           ...
           <tr><td><code>{@link #CheckBoxPreference_disableDependentsState android.support.compat:disableDependentsState}</code></td><td> The state (true for on, or false for off) that causes dependents to be disabled.</td></tr>
           <tr><td><code>{@link #CheckBoxPreference_summaryOff android.support.compat:summaryOff}</code></td><td> The summary for the Preference in a PreferenceActivity screen when the
             CheckBoxPreference is unchecked.</td></tr>
           <tr><td><code>{@link #CheckBoxPreference_summaryOn android.support.compat:summaryOn}</code></td><td> The summary for the Preference in a PreferenceActivity screen when the
...
containing a value of this type.
        ...
        */
        ...
        /** Attributes that can be used with a DialogPreference.
           ...
           <tr><td><code>{@link #DialogPreference_dialogIcon android.support.compat:dialogIcon}</code></td><td> The icon for the dialog.</td></tr>
           <tr><td><code>{@link #DialogPreference_dialogLayout android.support.compat:dialogLayout}</code></td><td> A layout to be used as the content View for the dialog.</td></tr>
           <tr><td><code>{@link #DialogPreference_dialogMessage android.support.compat:dialogMessage}</code></td><td> The message in the dialog.</td></tr>
           <tr><td><code>{@link #DialogPreference_dialogTitle android.support.compat:dialogTitle}</code></td><td> The title in the dialog.</td></tr>
           <tr><td><code>{@link #DialogPreference_negativeButtonText android.support.compat:negativeButtonText}</code></td><td> The negative button text for the dialog.</td></tr>
           <tr><td><code>{@link #DialogPreference_positiveButtonText android.support.compat:positiveButtonText}</code></td><td> The positive button text for the dialog.</td></tr>
           </table>
...
<tr><td><code>end</code></td><td>4</td><td></td></tr>
        ...
        */
        ...
        /** Attributes that can be used with a ListPreference.
           ...
           <tr><td><code>{@link #ListPreference_entries android.support.compat:entries}</code></td><td> The human-readable array to present as a list.</td></tr>
           <tr><td><code>{@link #ListPreference_entryValues android.support.compat:entryValues}</code></td><td> The array to find the value to save for a preference when an entry from
...
or to a theme attribute in the form "<code>?[<i>package</i>:][<i>type</i>:]<i>name</i></code>".
        ...
        */
        ...
        /** Attributes that can be used with a MultiSelectListPreference.
           ...
           <tr><td><code>{@link #MultiSelectListPreference_entries android.support.compat:entries}</code></td><td> The human-readable array to present as a list.</td></tr>
           <tr><td><code>{@link #MultiSelectListPreference_entryValues android.support.compat:entryValues}</code></td><td> The array to find the value to save for a preference when an entry from
             entries is selected.</td></tr>
           </table>
...
containing a value of this type.
        ...
        */
        ...
        /** Attributes that can be used with a Preference.
           ...
           <colgroup align="left" />
           <tr><th>Attribute</th><th>Description</th></tr>
           <tr><td><code>{@link #Preference_allowDividerAbove android.support.compat:allowDividerAbove}</code></td><td> Whether the preference allows displaying divider on top </td></tr>
           <tr><td><code>{@link #Preference_allowDividerBelow android.support.compat:allowDividerBelow}</code></td><td> Whether the preference allows displaying divider below it </td></tr>
           ...
           <tr><td><code>{@link #Preference_defaultValue android.support.compat:defaultValue}</code></td><td> The default value for the preference, which will be set either if persistence
             is off or persistence is on and the preference is not found in the persistent
             storage.</td></tr>
           <tr><td><code>{@link #Preference_dependency android.support.compat:dependency}</code></td><td> The key of another Preference that this Preference will depend on.</td></tr>
           <tr><td><code>{@link #Preference_enabled android.support.compat:enabled}</code></td><td> Whether the Preference is enabled.</td></tr>
           <tr><td><code>{@link #Preference_fragment android.support.compat:fragment}</code></td><td> When used inside of a modern PreferenceActivity, this declares
             a new PreferenceFragment to be shown when the user selects this item.</td></tr>
           <tr><td><code>{@link #Preference_icon android.support.compat:icon}</code></td><td> The optional icon for the preference </td></tr>
           <tr><td><code>{@link #Preference_iconSpaceReserved android.support.compat:iconSpaceReserved}</code></td><td> Whether the space for the preference icon view will be reserved.</td></tr>
           <tr><td><code>{@link #Preference_isPreferenceVisible android.support.compat:isPreferenceVisible}</code></td><td> Whether the Preference is visible.</td></tr>
           <tr><td><code>{@link #Preference_key android.support.compat:key}</code></td><td> The key to store the Preference value.</td></tr>
           <tr><td><code>{@link #Preference_layout android.support.compat:layout}</code></td><td> The layout for the Preference in a PreferenceActivity screen.</td></tr>
           <tr><td><code>{@link #Preference_order android.support.compat:order}</code></td><td> The order for the Preference (lower values are to be ordered first).</td></tr>
           <tr><td><code>{@link #Preference_persistent android.support.compat:persistent}</code></td><td> Whether the Preference stores its value to the shared preferences.</td></tr>
           <tr><td><code>{@link #Preference_selectable android.support.compat:selectable}</code></td><td> Whether the Preference is selectable.</td></tr>
           <tr><td><code>{@link #Preference_shouldDisableView android.support.compat:shouldDisableView}</code></td><td> Whether the view of this Preference should be disabled when
             this Preference is disabled.</td></tr>
           <tr><td><code>{@link #Preference_singleLineTitle android.support.compat:singleLineTitle}</code></td><td> Whether to use single line for the preference title text.</td></tr>
           <tr><td><code>{@link #Preference_summary android.support.compat:summary}</code></td><td> The summary for the Preference in a PreferenceActivity screen.</td></tr>
           <tr><td><code>{@link #Preference_title android.support.compat:title}</code></td><td> The title for the Preference in a PreferenceActivity screen.</td></tr>
           <tr><td><code>{@link #Preference_widgetLayout android.support.compat:widgetLayout}</code></td><td> The layout for the controllable widget portion of a Preference.</td></tr>
           </table>
...
containing a value of this type.
          <p>This is a private symbol.
          @attr name android.support.compat:isPreferenceVisible
        */
...
or to a theme attribute in the form "<code>?[<i>package</i>:][<i>type</i>:]<i>name</i></code>".
        ...
        */
        ...
        /** Attributes that can be used with a PreferenceFragment.
           ...
           <colgroup align="left" />
           <tr><th>Attribute</th><th>Description</th></tr>
           <tr><td><code>{@link #PreferenceFragment_allowDividerAfterLastItem android.support.compat:allowDividerAfterLastItem}</code></td><td> Whether a divider is allowed to draw after the last item </td></tr>
...
containing a value of this type.
        ...
        */
        ...
        /** Attributes that can be used with a PreferenceFragmentCompat.
           ...
           <colgroup align="left" />
           <tr><th>Attribute</th><th>Description</th></tr>
           <tr><td><code>{@link #PreferenceFragmentCompat_allowDividerAfterLastItem android.support.compat:allowDividerAfterLastItem}</code></td><td> Whether a divider is allowed to draw after the last item </td></tr>
...
containing a value of this type.
        ...
        */
        ...
        /** Attributes that can be used with a PreferenceGroup.
           ...
           <tr><td><code>{@link #PreferenceGroup_initialExpandedChildrenCount android.support.compat:initialExpandedChildrenCount}</code></td><td> The maximal number of children that are shown when the preference group is launched
             where the rest of the children will be hidden.</td></tr>
           <tr><td><code>{@link #PreferenceGroup_orderingFromXml android.support.compat:orderingFromXml}</code></td><td> Whether to order the Preference under this group as they appear in the XML file.</td></tr>
           </table>
...
containing a value of this type.
          <p>This is a private symbol.
          @attr name android.support.compat:initialExpandedChildrenCount
        */
...
containing a value of this type.
        ...
        */
        ...
        /** Attributes that can be used with a PreferenceTheme.
           ...
           <colgroup align="left" />
           <tr><th>Attribute</th><th>Description</th></tr>
           <tr><td><code>{@link #PreferenceTheme_checkBoxPreferenceStyle android.support.compat:checkBoxPreferenceStyle}</code></td><td> Default style for CheckBoxPreference.</td></tr>
           <tr><td><code>{@link #PreferenceTheme_dialogPreferenceStyle android.support.compat:dialogPreferenceStyle}</code></td><td> Default style for DialogPreference.</td></tr>
           <tr><td><code>{@link #PreferenceTheme_dropdownPreferenceStyle android.support.compat:dropdownPreferenceStyle}</code></td><td> Default style for DropDownPreference.</td></tr>
           <tr><td><code>{@link #PreferenceTheme_editTextPreferenceStyle android.support.compat:editTextPreferenceStyle}</code></td><td> Default style for EditTextPreference.</td></tr>
           <tr><td><code>{@link #PreferenceTheme_preferenceActivityStyle android.support.compat:preferenceActivityStyle}</code></td><td> Default style for the PreferenceActivity.</td></tr>
           <tr><td><code>{@link #PreferenceTheme_preferenceCategoryStyle android.support.compat:preferenceCategoryStyle}</code></td><td> Default style for PreferenceCategory.</td></tr>
           <tr><td><code>{@link #PreferenceTheme_preferenceFragmentCompatStyle android.support.compat:preferenceFragmentCompatStyle}</code></td><td> Default style for Headers pane in PreferenceActivity.</td></tr>
           <tr><td><code>{@link #PreferenceTheme_preferenceFragmentListStyle android.support.compat:preferenceFragmentListStyle}</code></td><td> Preference fragment list style </td></tr>
           <tr><td><code>{@link #PreferenceTheme_preferenceFragmentPaddingSide android.support.compat:preferenceFragmentPaddingSide}</code></td><td> Preference fragment padding side </td></tr>
           <tr><td><code>{@link #PreferenceTheme_preferenceFragmentStyle android.support.compat:preferenceFragmentStyle}</code></td><td> Default style for Headers pane in PreferenceActivity.</td></tr>
           <tr><td><code>{@link #PreferenceTheme_preferenceHeaderPanelStyle android.support.compat:preferenceHeaderPanelStyle}</code></td><td> Preference headers panel style </td></tr>
           <tr><td><code>{@link #PreferenceTheme_preferenceInformationStyle android.support.compat:preferenceInformationStyle}</code></td><td> Default style for informational Preference.</td></tr>
           <tr><td><code>{@link #PreferenceTheme_preferenceLayoutChild android.support.compat:preferenceLayoutChild}</code></td><td> The preference layout that has the child/tabbed effect.</td></tr>
           <tr><td><code>{@link #PreferenceTheme_preferenceListStyle android.support.compat:preferenceListStyle}</code></td><td> Preference list style </td></tr>
           <tr><td><code>{@link #PreferenceTheme_preferencePanelStyle android.support.compat:preferencePanelStyle}</code></td><td> Preference panel style </td></tr>
           <tr><td><code>{@link #PreferenceTheme_preferenceScreenStyle android.support.compat:preferenceScreenStyle}</code></td><td> Default style for PreferenceScreen.</td></tr>
           <tr><td><code>{@link #PreferenceTheme_preferenceStyle android.support.compat:preferenceStyle}</code></td><td> Default style for Preference.</td></tr>
           <tr><td><code>{@link #PreferenceTheme_preferenceTheme android.support.compat:preferenceTheme}</code></td><td> Theme for inflating Preference objects </td></tr>
           <tr><td><code>{@link #PreferenceTheme_ringtonePreferenceStyle android.support.compat:ringtonePreferenceStyle}</code></td><td> Default style for RingtonePreference.</td></tr>
           <tr><td><code>{@link #PreferenceTheme_seekBarPreferenceStyle android.support.compat:seekBarPreferenceStyle}</code></td><td> Default style for seekbar preferences.</td></tr>
           <tr><td><code>{@link #PreferenceTheme_switchPreferenceCompatStyle android.support.compat:switchPreferenceCompatStyle}</code></td><td> Default style for switch compat preferences.</td></tr>
           <tr><td><code>{@link #PreferenceTheme_switchPreferenceStyle android.support.compat:switchPreferenceStyle}</code></td><td> Default style for switch preferences.</td></tr>
           <tr><td><code>{@link #PreferenceTheme_yesNoPreferenceStyle android.support.compat:yesNoPreferenceStyle}</code></td><td> Default style for YesNoPreference.</td></tr>
           </table>
...
or to a theme attribute in the form "<code>?[<i>package</i>:][<i>type</i>:]<i>name</i></code>".
        ...
        */
        ...
        /** Attributes that can be used with a SeekBarPreference.
           ...
           <colgroup align="left" />
           <tr><th>Attribute</th><th>Description</th></tr>
           <tr><td><code>{@link #SeekBarPreference_adjustable android.support.compat:adjustable}</code></td><td> Attribute indicating whether the slider within this preference can be adjusted, that is
        pressing left/right keys when this preference is focused will move the slider accordingly
        (e.</td></tr>
           ...
           <tr><td><code>{@link #SeekBarPreference_seekBarIncrement android.support.compat:seekBarIncrement}</code></td><td>Attribute controlling the amount to increment or decrement the seekbar when the user
        presses the arrow keys</td></tr>
           <tr><td><code>{@link #SeekBarPreference_showSeekBarValue android.support.compat:showSeekBarValue}</code></td><td> Flag indicating whether the TextView next to the seekbar that shows the current seekbar
...
<tr><td><code>add</code></td><td>16</td><td> Combines the tint and drawable color and alpha channels, clamping the
        ...
        */
        ...
        /** Attributes that can be used with a SwitchPreference.
           ...
           <tr><td><code>{@link #SwitchPreference_disableDependentsState android.support.compat:disableDependentsState}</code></td><td> The state (true for on, or false for off) that causes dependents to be disabled.</td></tr>
           <tr><td><code>{@link #SwitchPreference_summaryOff android.support.compat:summaryOff}</code></td><td> The summary for the Preference in a PreferenceActivity screen when the
             SwitchPreference is unchecked.</td></tr>
           <tr><td><code>{@link #SwitchPreference_summaryOn android.support.compat:summaryOn}</code></td><td> The summary for the Preference in a PreferenceActivity screen when the
             SwitchPreference is checked.</td></tr>
           <tr><td><code>{@link #SwitchPreference_switchTextOff android.support.compat:switchTextOff}</code></td><td> The text used on the switch itself when in the "off" state.</td></tr>
           <tr><td><code>{@link #SwitchPreference_switchTextOn android.support.compat:switchTextOn}</code></td><td> The text used on the switch itself when in the "on" state.</td></tr>
           </table>
...
containing a value of this type.
        ...
        */
        ...
        /** Attributes that can be used with a SwitchPreferenceCompat.
           ...
           <tr><td><code>{@link #SwitchPreferenceCompat_disableDependentsState android.support.compat:disableDependentsState}</code></td><td> The state (true for on, or false for off) that causes dependents to be disabled.</td></tr>
           <tr><td><code>{@link #SwitchPreferenceCompat_summaryOff android.support.compat:summaryOff}</code></td><td> The summary for the Preference in a PreferenceActivity screen when the
             SwitchPreference is unchecked.</td></tr>
           <tr><td><code>{@link #SwitchPreferenceCompat_summaryOn android.support.compat:summaryOn}</code></td><td> The summary for the Preference in a PreferenceActivity screen when the
             SwitchPreference is checked.</td></tr>
           <tr><td><code>{@link #SwitchPreferenceCompat_switchTextOff android.support.compat:switchTextOff}</code></td><td> The text used on the switch itself when in the "off" state.</td></tr>
           <tr><td><code>{@link #SwitchPreferenceCompat_switchTextOn android.support.compat:switchTextOn}</code></td><td> The text used on the switch itself when in the "on" state.</td></tr>
           </table>
